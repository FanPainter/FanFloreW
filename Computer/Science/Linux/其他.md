...
- [[openwrt\] ubus实现进程间通信举例 - LiuYanYGZ - 博客园 (cnblogs.com)](https://www.cnblogs.com/LiuYanYGZ/p/14204802.html)

​        前置操作

- [记一次 Centos7 cmake 版本升级（由 v2.8.12.2 升级至 v3.14.5）_centos7 cmake 3.16...3.27 or higher is required. -CSDN博客](https://blog.csdn.net/llwy1428/article/details/95473542)
- [新手如何在CentOS7中C++使用jsoncpp_amalgamated source-CSDN博客](https://blog.csdn.net/The_Time_Runner/article/details/107295679)
...
ubusd-->A("server:object")
client1--subscribe-->ubusd
client2--subscribe-->ubusd
client3--subscribe-->ubusd
```
...
​        下面这个例子中，server注册了一个名为“test”的对象，并定期广播消息。而client去订阅这个对象，并对server发出的消息做处理。
