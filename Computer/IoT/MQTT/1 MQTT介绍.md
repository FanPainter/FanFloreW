...
- **MQTT 客户端**：任何运行 MQTT 客户端库的应用或设备都是 MQTT 客户端。
...
- **主题**：MQTT 协议根据主题来转发消息。主题通过 `/` 来区分层级，类似于 URL 路径
...
- **全托管的云服务**：通过全托管的云服务启动 MQTT 服务是最便捷的方式。如下图所示，EMQX Serverless 版本是基于多租户架构的 MQTT 云服务，具有按量付费和灵活扩容的特性，可以在几分钟内启动，并在 AWS、Google Cloud 和 Microsoft Azure 的 17 个区域提供运行支持
- **免费的公共 MQTT Broker**：使用 EMQ 提供的[免费的公共 MQTT 服务器](https://www.emqx.com/zh/mqtt/public-mqtt5-broker)，它基于完全托管的 [MQTT 云服务 - EMQX Cloud](https://www.emqx.com/zh/cloud) 创建